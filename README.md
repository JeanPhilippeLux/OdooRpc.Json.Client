...
OdooRpc.Json.Client is a C# library (.NET Standard) for communication with Odoo.
This is a Fork from PortaCapena.OdooJsonRpcClient. The original project wasn't evoluate anymore, so I create this one with new functionnality.


For example and test, go to https://www.nuget.org/packages/PortaCapena.OdooJsonRpcClient/
